...
4. write a program that takes shows good morning 10 times using function without using loops
5. write a program that username as input and displays it in  email format. (name+@msn.net) using functions
